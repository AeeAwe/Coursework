    ...
    <div class="container padding-y-50">
        <div class="footer-flex">
            <div class="footer-left">
                <div class="logo"><img src="{{ asset('icon/logo-unfilled.svg') }}" alt="логотип"></div>
                <ul class="nav-list">
        ...
        <div class="footer-sign">© 2026 — Курсовой проект <i><a href="https://t.me/aee_awe" class="nav-link">by AeeAwe</a></i></div>
    </div>
</footer>
