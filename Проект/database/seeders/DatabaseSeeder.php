...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Abonement::create([
            ...
            'visits' => 10,
            'price' => 1700,
            'description' => 'Абонемент на 10 занятий, действующий 3 месяца с момента активации',
        ]);
        Abonement::create([
            'name' => 'Абонемент 20 занятий',
            'visits' => 20,
            'price' => 3500,
            'description' => 'Абонемент на 20 занятий, действующий 6 месяцев с момента активации',
        ]);
        Abonement::create([
            'name' => 'Безлимитный месяц',
            'visits' => 9999,
            'price' => 9999,
            'description' => 'Безлимитные занятия в течение одного месяца',
        ]);
